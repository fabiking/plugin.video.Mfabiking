...
cbx_pages = xbmc.translatePath(os.path.join('special://home/userdata/adon_data/plugin.video.palcotv/art/cbx', ''))
playlists = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.palcotv/playlists', ''))
tmp = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.palcotv/tmp', ''))
